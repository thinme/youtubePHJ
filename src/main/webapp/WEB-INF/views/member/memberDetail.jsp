	        ...
	        <div id="layoutSidenav_content">
	            <main class="bg-light">
	                <div class="container-fluid px-4">
                        <h1 class="mt-4">Member Detail</h1>
                            		...
                            		<div class="px-5-mod text-center">
		                                ...
		                                <input type="hidden" id="memberIdx" value="${memDetail.memberIdx}">
			                                <div class="row">
			                                 ...
			                                 <div class="col-md-6">
			                                  <div class="form-floating mt-2 mb-4">
			                                  	<input class="form-control" id="inputAuth" name="memberAuth" type="text" value="${memDetail.memberAuth}" readonly="readonly"/>
			                                ...
			                                <div class="row">
			                                 ...
			                                 <div class="col-md-6">
			                                  <div class="form-floating mb-4">
			                                  	<input class="form-control" id="inputGender" name="memberGender" type="text" value="${memDetail.memberGender}" readonly="readonly"/>
