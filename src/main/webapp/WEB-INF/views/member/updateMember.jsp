                            	...
                            	<div class="row d-flex align-items-center justify-content-center">
                            		<div class="px-5-mod text-center">
		                                ...
		                                <input type="hidden" id="memberIdx" name="memberIdx" value="${memDetail.memberIdx}">
			                                <div class="row">
			                                 <div class="col-md-6">
			                                  	<div class="form-floating mt-2 mb-4">
				                                    <input class="form-control" id="inputId" name="memberId" type="text" value="${memDetail.memberId}" placeholder="아이디를 입력하세요"/>
			                                ...
			                                <div class="row">
			                                 <div class="col-md-6">
			                                  <div class="form-floating mb-4">
			                                  	<input class="form-control" id="inputName" name="memberName" type="text" value="${memDetail.memberName}" placeholder="이름을 입력하세요"/>
			                                ...
			                                <div class="form-floating mb-4">
			                                    <input class="form-control" id="inputEmail" name="memberEmail" type="text" value="${memDetail.memberEmail}" placeholder="이메일을 입력하세요"/>
			                                    <label for="inputEmail">Email</label>
			                                </div>
			                                <div class="form-floating mb-4">
			                                    <input class="form-control" id="inputChannelName" name="memberChannelName" type="text" value="${memDetail.memberChannelName}" placeholder="채널명을 입력하세요"/>
