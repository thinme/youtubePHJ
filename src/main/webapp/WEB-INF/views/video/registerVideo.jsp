	        ...
	        <div id="layoutSidenav_content">
	            <main>
	                <div class="container-fluid px-4">
	                    <h2 class="mt-4"><i class='bx bx-video-plus'></i>&nbsp;Register Video</h2>
	                    <ol class="breadcrumb mb-4">
	                        <li class="breadcrumb-item active" style="margin-left:42px;">영상 등록</li>
	                    </ol>
	                    <div class="card">
			                <div class="card-body">
			                	<form id="regVideoFrm" method="post">
			                		<input type="hidden" name="videoRegId" value="${sesMemberId}">
			                		<input type="hidden" name="videoRegIp" value="${sesMemberIp}">
	                                <div class="form-floating mt-2 mb-4">
	                                    <input class="form-control" id="videoIdentifiedId" name="videoIdentifiedId" type="text" style="width: 30%;"/>
	                                ...
	                                <div class="form-floating mb-4">
	                                    <textarea class="form-control" id="videoContents" name="videoContents" style="height: 240px;"></textarea>
